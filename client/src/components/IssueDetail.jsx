  ...
  return (
    ...
    <div className='text-3xl text-center font-bold mt-7'>
      ...
      <div className='flex flex-col h-full mr-5 mt-52 justify-end items-end '>
        <Link to={`/solution/${issueId}`} className='p-5 shadow hover:shadow-xl flex items-center justify-center gap-2 mb-5 px-3 py-3 font-bold bg-gray-900 text-white rounded-md'> 
