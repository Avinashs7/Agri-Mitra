    ...
    <>
        <nav className="bg-gray-800">
            <div className="max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex flex-1 h-20 items-center justify-between">
                    <div className="absolute inset-y-0 left-0 flex flex-1 items-center sm:hidden">
                    {/* <!-- Mobile menu button--> */}
...
// import logo from '.logo.png'; // Update this path to the actual location of your logo
...
//                   <Link to="/about" className="rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About Us</Link>
//                   <Link to="/projects" className="rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Projects</Link>
//                   <Link to="/calendar" className="rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Calendar</Link>
//                 </div>
//               </div>
//             </div>
//             <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
//               <Link to="/login" className="rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
//                 Sign In
//               </Link>
//             </div>
//           </div>
