...
const Vision = () => {
  ...
  return (
    <div>
      <div className="bg-gray-900 pt-10 pb-8">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-300 sm:text-6xl" data-aos='fade-left'>Vision and Mission</h1>
            </div>
            <div className="mx-auto mt-14 sm:mt-20 lg:mt-24 lg:max-w-4xl pb-10">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                <div className="relative border border-solid border-white" data-aos='fade-left'>
